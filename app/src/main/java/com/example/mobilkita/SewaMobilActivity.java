...
public class SewaMobilActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener { //class sewamobilactivity dengan extend appcompatactivity implement
    //deklarasi edit text, radioGroup, radio button, dan button
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { //method untuk membuat data penyewaaan pada layout activity_sewa untuk menambahkan datanya dengan diisi oleh user
    ...
    private void setupToolbar() { //untuk membuat tampilan atas pada layout
    ...
    @Override //untuk menampilkan item menu (menu yang titik tiga)
    ...
    private void loadSpinnerData() {
        DataHelper db = new DataHelper(getApplicationContext()); //daridatabase datahelper
