...
public class DetailPenyewaActivity extends AppCompatActivity {
    ...
    String sNama, sAlamat, sHP, sMerk, sHarga; //deklarasi string, item dan double
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {//membuat dan memanggil data dari database yang sudah dibuat dengan code query
        ...
        //code untuk menampilkan ke fitur masukkan dan menampilkan hasil data penyewaan
    ...
    //method untuk menampilkan nama detail penyewa
    ...
    //method untuk menampilkan menu di titik tiga di home
    @Override
