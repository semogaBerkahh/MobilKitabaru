package com.example.mobilkita.helper;
...
public class DataHelper extends SQLiteOpenHelper {
    ...
    @Override
    public void onCreate(SQLiteDatabase db) {   //method untuk membuat database
    ...
    public List<String> getAllCategories() {    //databse untuk memanggil kategori mobil
